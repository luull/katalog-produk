                  ...
                  <table id="dt-table" class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$d->created_by}}</td>
                                <td>
                                    <a href="#" class="edit" id="e-{{$d->sbid}}" alt="Edit"><i data-feather="edit"></i></a>
                                    <a href="/backend/category/delete/{{$d->sbid}}" alt="Delete"><i data-feather="trash" class="text-danger"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Kategori</label>
                                <select name="id_category" id="edit_id_category" class="form-control" id="">
                                    @foreach ($category as $c )
                                    <option id="edit_id_category" value="{{$c->id}}">{{$c->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Nama Kategori</label>
                                <input type="text" class="form-control" id="edit_sub_category" name="sub_category">
                                @error('sub_category')
                                <br>
                                <div class="text-danger mt-1">This field is required</div>
                                @enderror
            ...
            $.ajax({
                ...
                success:function(hsl) {
                   if (hsl.error){
                    ...
                    $("#edit_sub_category").val(hsl.sub_category);
                    $("#editModal").modal();
