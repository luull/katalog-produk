        ...
        <header class="header navbar navbar-expand-sm">
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="/">
                        <img src="{{ asset('templates/assets/img/tokped.png')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
            </ul>
                ...
                <li class="nav-item align-self-center search-animated">
                    ...
                    <form class="form-inline search-full form-inline search" role="search" action="{{ route('findproduk') }}"  method="GET">
                        <div class="search-bar">
                            <input type="text" class="form-control search-form-control ml-lg-auto" name="search" value="{{ $search ?? $getcategory->name ?? '' }}" placeholder="Search...">
                        </div>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                ...
                @else
                <li class="nav-item align-self-center ml-3">
                   <a href="/cart" class="position-relative"><i class="fa fa-shopping-cart" style="color:#686868;font-size:24px;"></i></a>
                </li>
